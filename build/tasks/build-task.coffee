...
module.exports = (grunt) ->
  ...
  grunt.registerTask 'build', 'Build the application', ->
    ...
    if process.platform is 'darwin'
      ...
      fs.renameSync path.join(shellAppDir, 'Contents', 'MacOS', 'Electron'), path.join(shellAppDir, 'Contents', 'MacOS', 'Juno')
      fs.renameSync path.join(shellAppDir, 'Contents', 'Frameworks', 'Electron Helper.app'), path.join(shellAppDir, 'Contents', 'Frameworks', 'Juno Helper.app')
      fs.renameSync path.join(shellAppDir, 'Contents', 'Frameworks', 'Juno Helper.app', 'Contents', 'MacOS', 'Electron Helper'), path.join(shellAppDir, 'Contents', 'Frameworks', 'Juno Helper.app', 'Contents', 'MacOS', 'Juno Helper')
    else
